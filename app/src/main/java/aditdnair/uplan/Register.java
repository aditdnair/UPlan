...
public class Register extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConfirmView = (EditText) findViewById(R.id.password2);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.registerb);
    ...
    private void attemptLogin() {
        ...
        if(password.length() == 0){
            ...
            mConfirmView.setError("Password does not match");
    ...
    protected void proceed(){
        showProgress(false);
        if (success) {
            Intent intent = new Intent("aditdnair.uplan.Dashboard");
